...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        'nombres', 'apellidos', 'password', 'email', 'tipoUsuario_id', 'fechaNacimiento', 'estadoCivil', 'sexo', 'nacionalidad', 'direccion', 'telefono', 'tipoSangre', 'nivelEstudio', 'perfilProfesional','cedula',
    ];
